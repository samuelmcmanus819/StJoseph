  ...
  return (
    <Box sx={{px: "10%"}}>
      ...
      <Box sx={{px: { xs: 0, md: "16%" }, display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
        ...
        <Typography sx={{display: 'flex', alignSelf: 'start'}}>Anointing of the Sick every first Friday of the month during 8:00 AM Mass. For emergency please call the parish office <a href={`tel:(936) 344-6104`}>(936) 344-6104</a>.</Typography>
      </Box>
    </Box>
  )
}
