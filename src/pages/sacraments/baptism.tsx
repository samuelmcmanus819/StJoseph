    ...
    <Box sx={{px: "10%", pb: "4vh"}}>
      ...
      <Box sx={{px: { xs: 0, md: "16%" }, display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'start'}}>
        ...
        <List sx={{ listStyleType: "disc", pl: 4 }}>
          <ListItem sx={{ display: "list-item" }}>Parents who are registered members are to contact the church office in the 4th or 5th month of pregnancy</ListItem>
          <ListItem sx={{ display: "list-item" }}>Parents must set up an appointment to meet with the priest or deacon in order to fix the date of the Baptism and fill in the necessary questionnaire.  Call the church office to make arrangements.  The  priest or deacon will contact you  to set an appointment.</ListItem>
          <ListItem sx={{ display: "list-item" }}>Parents who are Catholics but are not married in a Catholic Church (Civil Marriage) are required to contact the priest about validation of their marriage.</ListItem>
          <ListItem sx={{ display: "list-item" }}>Both parents are expected to be aware of the ritual of the Baptism Sacrament and the godparents too must be made aware of their responsibilities.</ListItem>
          <ListItem sx={{ display: "list-item" }}>It is customary in the Catholic Church to have one godmother and one godfather. Godparents must be Catholic, above 16 years of age, and have received the three sacraments of initiation (that is Baptism, Confirmation and Eucharist). Godparents must be actively practicing their faith.</ListItem>
          <ListItem sx={{ display: "list-item" }}>Baptism may be delayed or postponed for non-compliance with any of above and for non-practice of the Catholic faith.</ListItem>
        </List>
        ...
        <List sx={{ listStyleType: "disc", pl: 4 }}>
          <ListItem sx={{ display: "list-item" }}>A godparent for a Catholic Baptism must be a fully initiated practicing Catholic. Non-Catholics may not serve as godparents for a Catholic Baptism.</ListItem>
          <ListItem sx={{ display: "list-item" }}>At least one godparent is required; no more than two (one male and one female) are allowed.</ListItem>
          <ListItem sx={{ display: "list-item" }}>The Godparent needs to be a practicing Catholic who is at least sixteen (16) years of age.</ListItem>
          <ListItem sx={{ display: "list-item" }}>The godparent must be fully initiated in the Catholic Church, that is, they must have received the sacraments of Baptism, First Communion, and Confirmation.  Regular attendance at Mass is expected.  Regular participation in the Sacrament of Reconciliation is encouraged.</ListItem>
          <ListItem sx={{ display: "list-item" }}>If married, the godparent needs to be in a marriage considered valid in the Catholic Church. This may be proved with a recent copy of the person’s Baptismal certificate; the godparents may be asked to provide this document to the Church Office.</ListItem>
          <ListItem sx={{ display: "list-item" }}>In order to prepare for the celebration of this sacrament, we ask that godparents attend Baptism classes (here or elsewhere).</ListItem>
        </List>
        ...
        <List sx={{ listStyleType: "disc", pl: 4, mt: -2 }}>
          <ListItem sx={{ display: "list-item" }}>Attendance at classes is expected.</ListItem>
          <ListItem sx={{ display: "list-item" }}>Registration for the classes is required.</ListItem>
          <ListItem sx={{ display: "list-item" }}>Both parents and godparents should attend classes.</ListItem>
          <ListItem sx={{ display: "list-item" }}>If the classes are taken at another parish, a letter stating that they were completed is requested.</ListItem>
        </List>
