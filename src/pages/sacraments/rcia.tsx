  ...
  return (
    <Box sx={{px: "10%"}}>
      ...
      <Box sx={{px: { xs: 0, md: "16%" }, display: 'flex', flexDirection: 'column', alignItems: 'center', mb: "4vh"}}>
        <img src="/sacraments/rcia.jpg" width={300}/>
        ...
        <List sx={{ listStyleType: "disc", pl: 4 }}>
          <ListItem sx={{ display: "list-item" }}>All adults (unbaptized, baptized non-Catholic, or baptized Catholic) who would like to ask questions and get answers so they can make an educated and informed decision about becoming or being a Catholic.</ListItem>
          <ListItem sx={{ display: "list-item" }}>Baptized Catholic adults who need to complete their Catholic lives by receiving the Sacrament(s) of:Eucharist, Reconciliation and/or Confirmation. </ListItem>
          <ListItem sx={{ display: "list-item" }}>Anyone interested in continuing education in Catholicism.</ListItem>
        </List>
      </Box>
    </Box>
  )
