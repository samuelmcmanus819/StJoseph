    ...
    <Box sx={{px: "10%"}}>
      ...
      <Box sx={{px: { xs: 0, md: "16%" }, display: 'flex', flexDirection: 'column', alignItems: 'center', mb: "4vh"}}>
        ...
        <List sx={{ listStyleType: "disc", pl: 4 }}>
          <ListItemText sx={{ display: "list-item" }}>All adults (unbaptized, baptized non-Catholic, or baptized Catholic) who would like to ask questions and get answers so they can make an educated and informed decision about becoming or being a Catholic.</ListItemText>
          <ListItemText sx={{ display: "list-item" }}>Baptized Catholic adults who need to complete their Catholic lives by receiving the Sacrament(s) of:Eucharist, Reconciliation and/or Confirmation. </ListItemText>
          <ListItemText sx={{ display: "list-item" }}>Anyone interested in continuing education in Catholicism.</ListItemText>
        </List>
      </Box>
    </Box>
  )
